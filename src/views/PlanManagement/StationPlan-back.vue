 ...
 * @LastEditors: WangXin
 * @LastEditTime: 2023-02-09 16:18:43
      ...
      <div class="data">
        <div class="top" v-show="showNowTask">
          <el-table class="normal-table cmd-table" :data="tableData">
            ...
            <el-table-column label="任务内容" align="center" min-width="110px">
              <template slot-scope="scope">
            ...
            <div class="process">
              ...
              <div class="prosess-step">
                ...
                <div class="prosess-line">
                  ...
                  <div class="prosess-line-container" :style="{ width: 50 + '%' }">
                    <div class="wave">
                      <!-- <div class=""> </div> -->
                    </div>
                  </div>
        ...
        <div class="bottom">
          <div class="station-plan-list" :class="{ full: !showNowTask }">
            ...
            <el-table class="normal-table cmd-table" :data="planListTableData" :row-style="getRowStyle">
              ...
              <el-table-column v-if="!showNowTask" label="任务内容" align="center" min-width="110px">
                <template slot-scope="scope">
                  <span>{{ getContent(scope.row.content) || '-' }}</span>
                </template>
              </el-table-column>
            ...
            <div class="log-list" v-if="taskLog?.taskLogDetailVOList">
              <div v-for="item in taskLog?.taskLogDetailVOList" :key="item.id" :class="`log-item ${statusClass[item.logLevel]}`">
                ...
                <div class="log-item-content">
                  ...
                  <div class="log-item-desc ellipse" v-if="item.errorMsg">原因：{{ item.errorMsg }}</div>
                </div>
              </div>
            </div>
      ...
      <template v-slot:body>
        <div class="dialog-content">
          ...
          <div class="content">
            ...
            <div class="content-item">
              <div class="key font-medium">类型</div>
              <div class="value">{{ checkContent.satelliteType || '-' }}</div>
            </div>
          </div>
          ...
          <div class="content">
            ...
            <div class="content-item">
              <div class="key font-medium">任务内容</div>
            ...
            <div class="content-item">
              <div class="key font-medium">功率dBm</div>
              <div class="value">{{ checkContent.power || '-' }}</div>
            </div>
            <div class="content-item">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      patternMap: { 1: '标准模式', 2: '扩频二模式', 3: '低速数传', 4: '双通路数传', 5: '测控 + 单通道', 6: '测控 + 双通道' },
      sourceMap: { 1: '中心', 2: '站内' },
      queryType: 2,
      statusClass: {
        1: 'success-log',
  ...
  methods: {
    ...
    async getNowTask() {
      ...
      if (data.code == 200) {
        ...
        this.taskStartTime = moment(moment(this.nowInfo.startTime) - 300000).format('YYYY-MM-DD HH:mm:ss');
...
@keyframes rotate {
  50% {
    transform: translate(100%, -71%) rotate(180deg);
  }
  100% {
